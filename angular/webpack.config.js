...
module.exports = {
  ...
  "entry": {
    ...
    "scripts": [
      ...
      "script-loader!./src/assets/semantic/semantic.min.js"
    ],
    "styles": [
      "./src/styles.css",
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "src/assets/semantic/semantic.min.css"),
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      ...
      "globOptions": {
        "cwd": "/Users/kevinlanglois/www/local.storypoint.io/angular/src",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
